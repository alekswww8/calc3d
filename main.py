...
LANGUAGES = {
    "UA": {
        ...
        "btn_file": "📁 ОБРАТИ STL",
        "btn_view3d": "👁️ 3D ПЕРЕГЛЯД",
        "no_file": "Файл не обрано",
        "loading": "Триває розрахунок...",
        "history": "📋 Історія",
        "vase_on": "🏺 Режим вази: УВІМК",
        "vase_off": "🏺 Режим вази: ВИМК",
        "walls": "Стінки (периметри):",
        "infill": "Заповнення (%):",
        "spool": "Котушка 1 кг (грн):",
        "hour": "Верстат + світло (грн/год):",
        "markup": "Маржа / Націнка (x):",
        "speed": "Швидкість (см³/год):",
        "weight": "Вага деталі (г):",
        "time": "Час друку (год):",
        "nozzle": "Сопло",
        "initial_result": "Оберіть деталь — розрахунок з'явиться тут",
        "btn_share": "📤 ВІДПРАВИТИ ЧЕК",
        "btn_save": "💾 ЗБЕРЕГТИ В БАЗУ",
        "share_title": "Відправка чека",
        "share_hint": "Чек скопійовано в буфер! Оберіть додаток:",
        "btn_tg": "✈️ Telegram",
        "btn_viber": "🟣 Viber",
        "btn_wa": "🟢 WhatsApp",
        "btn_copy": "📋 Тільки скопіювати",
        "saved_msg": "Замовлення успішно збережено!",
        "copied_msg": "Чек скопійовано в буфер обміну!",
        ...
        "vol": "Об'єм",
        "area": "Площа",
        "receipt_header": "🧾 Розрахунок вартості 3D-друку",
        "receipt_file": "Файл",
        "receipt_mat": "Матеріал",
        "receipt_weight": "Вага",
        "receipt_time": "Час",
        "receipt_total": "Разом до сплати",
        "viewer_title": "3D Перегляд моделі",
        "viewer_hint": "Свайп: Обертання | Два пальці: Зум"
    },
    "RU": {
        "title": "3D КАЛЬКУЛЯТОР",
        "btn_file": "📁 ВЫБРАТЬ STL",
        "btn_view3d": "👁️ 3D ПРОСМОТР",
        "no_file": "Файл не выбран",
        "loading": "Идет расчет...",
        "history": "📋 История",
        "vase_on": "🏺 Режим вазы: ВКЛ",
        "vase_off": "🏺 Режим вазы: ВЫКЛ",
        "walls": "Стенки (периметры):",
        "infill": "Заполнение (%):",
        "spool": "Катушка 1 кг (грн):",
        "hour": "Станок + свет (грн/ч):",
        "markup": "Маржа / Наценка (x):",
        "speed": "Скорость (см³/ч):",
        "weight": "Вес детали (г):",
        "time": "Время печати (ч):",
        "nozzle": "Сопло",
        "initial_result": "Выберите деталь — расчет появится здесь",
        "btn_share": "📤 ОТПРАВИТЬ ЧЕК",
        "btn_save": "💾 СОХРАНИТЬ В БАЗУ",
        "share_title": "Отправка чека",
        "share_hint": "Чек скопирован в буфер! Выберите мессенджер:",
        "btn_tg": "✈️ Telegram",
        "btn_viber": "🟣 Viber",
        "btn_wa": "🟢 WhatsApp",
        "btn_copy": "📋 Только скопировать",
        "saved_msg": "Заказ успешно сохранен!",
        "copied_msg": "Чек скопирован в буфер обмена!",
        ...
        "vol": "Объем",
        "area": "Площадь",
        "receipt_header": "🧾 Расчет стоимости 3D-печати",
        "receipt_file": "Файл",
        "receipt_mat": "Материал",
        "receipt_weight": "Вес",
        "receipt_time": "Время",
        "receipt_total": "Итого к оплате",
        "viewer_title": "3D Просмотр модели",
        "viewer_hint": "Свайп: Вращение | Два пальца: Зум"
    },
    "EN": {
        "title": "3D PRINT CALC",
        "btn_file": "📁 CHOOSE STL",
        "btn_view3d": "👁️ 3D VIEW",
        "no_file": "No file chosen",
        "loading": "Calculating...",
        "history": "📋 History",
        "vase_on": "🏺 Vase mode: ON",
        "vase_off": "🏺 Vase mode: OFF",
        "walls": "Perimeters (walls):",
        "infill": "Infill (%):",
        "spool": "Spool 1 kg (uah):",
        "hour": "Printer + power (uah/h):",
        "markup": "Markup / Margin (x):",
        "speed": "Speed (cm³/h):",
        "weight": "Part weight (g):",
        "time": "Print time (h):",
        "nozzle": "Nozzle",
        "initial_result": "Select part — quote will appear here",
        "btn_share": "📤 SHARE QUOTE",
        "btn_save": "💾 SAVE TO DB",
        "share_title": "Share Quote",
        "share_hint": "Quote copied to clipboard! Select app:",
        "btn_tg": "✈️ Telegram",
        "btn_viber": "🟣 Viber",
        "btn_wa": "🟢 WhatsApp",
        "btn_copy": "📋 Copy only",
        "saved_msg": "Order saved successfully!",
        "copied_msg": "Quote copied to clipboard!",
        ...
        "vol": "Volume",
        "area": "Area",
        "receipt_header": "🧾 3D Print Quote",
        "receipt_file": "File",
        "receipt_mat": "Material",
        "receipt_weight": "Weight",
        "receipt_time": "Time",
        "receipt_total": "Total Amount",
        "viewer_title": "3D Model Viewer",
        "viewer_hint": "Swipe: Rotate | Pinch: Zoom"
    }
}
...
class Mobile3DView(Widget):
    ...
    def project(self, x, y, z):
        ...
        px = center_x + x1 * self.zoom
        py = center_y + y2 * self.zoom
        return px, py
...
class StudioCalcMobileApp(App):
    ...
    def apply_language(self):
        ...
        for c in ["UA", "RU", "EN"]:
            b = ids[f"btn_lang_{c.lower()}"]
            b.background_color = (0.23, 0.51, 0.96, 1) if c == self.cur_lang else (0.12, 0.14, 0.19, 1)
    ...
    def open_3d_viewer(self):
        ...
        v3d = Mobile3DView(self.mesh_points)
        box.addWidget(v3d)

        lbl_h = Label(text=self.tr("viewer_hint"), font_size='12sp', color=(0.6, 0.65, 0.7, 1), size_hint_y=None, height='24dp')
        box.addWidget(lbl_h)

        btn_c = Button(text=self.tr("btn_close"), size_hint_y=None, height='38dp', bold=True,
    ...
    def recalc(self, *args):
        ...
        try:
            ...
            if self.vase_mode:
                th_cm = (self.nozzle * 1.1) / 10.0
                u_vol = self.area_cm2 * th_cm
            else:
                th_cm = (walls * self.nozzle) / 10.0
                s_vol = self.area_cm2 * th_cm
            ...
            cost_p = (spool_c / 1000.0) * calc_w
            cost_m = hour_r * calc_t
            self.total_cost = (cost_p + cost_m) * markup
    ...
    def get_receipt_text(self):
        w = self.inputs["weight"].text
        t = self.inputs["time"].text
        sym = "грн" if self.cur_lang != "EN" else "uah"
        return (
            ...
            f"• {self.tr('receipt_weight')}: {w} g | {self.tr('receipt_time')}: {t} h\n"
            f"────────────────────────\n"
    ...
    def open_share_dialog(self):
        if self.total_cost <= 0:
            return
        text = self.get_receipt_text()
        Clipboard.copy(text)
        enc = urllib.parse.quote(text)

        box = BoxLayout(orientation='vertical', spacing='8dp', padding='10dp')
        lbl = Label(text=self.tr("share_hint"), font_size='13sp', color=(0.38, 0.65, 0.98, 1))
        box.addWidget(lbl)
        ...
        btn_tg = Button(text=self.tr("btn_tg"), background_normal='', background_color=(0.13, 0.62, 0.85, 1), size_hint_y=None, height='38dp', bold=True)
        btn_tg.bind(on_release=lambda x: share_to(f"tg://msg_url?text={enc}"))
        box.addWidget(btn_tg)

        btn_viber = Button(text=self.tr("btn_viber"), background_normal='', background_color=(0.45, 0.38, 0.95, 1), size_hint_y=None, height='38dp', bold=True)
        btn_viber.bind(on_release=lambda x: share_to(f"viber://forward?text={enc}"))
        box.addWidget(btn_viber)

        btn_wa = Button(text=self.tr("btn_wa"), background_normal='', background_color=(0.15, 0.83, 0.4, 1), size_hint_y=None, height='38dp', bold=True)
        btn_wa.bind(on_release=lambda x: share_to(f"whatsapp://send?text={enc}"))
        box.addWidget(btn_wa)

        btn_cp = Button(text=self.tr("btn_copy"), background_normal='', background_color=(0.2, 0.24, 0.32, 1), size_hint_y=None, height='36dp', bold=True)
        btn_cp.bind(on_release=lambda x: pop.dismiss())
        box.addWidget(btn_cp)
    ...
    def save_order(self):
        ...
        conn = sqlite3.connect(self.db_path)
        cur = conn.cursor()
        cur.execute("INSERT INTO orders (dt, filename, material, weight, hours, cost) VALUES (?, ?, ?, ?, ?, ?)",
